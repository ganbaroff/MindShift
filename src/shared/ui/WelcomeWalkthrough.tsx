    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pb-3">
        ...
        <div className="flex gap-2">
          <button
            onClick={handleSkip}
            className="text-[12px] px-2 py-1 rounded-lg focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:outline-none"
          ...
          <button
            onClick={handleNext}
            className="text-[12px] px-3 py-1 rounded-lg font-medium focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:outline-none"
            style={{
