...
export function AddTaskModal({ open, onClose }: Props) {
  const { addTask, nowPool, nextPool, userId, hasAchievement, unlockAchievement, appMode, seasonalMode } = useStore()
  ...
  const nowPoolMax = getNowPoolMax(appMode, seasonalMode)
