 ...
 * - Gradient fills using design tokens (#6C63FF → #4ECDC4)
 *
...
function SeedlingSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Tiny second leaf */}
      <path d="M32 40C36 37 38 34 34 33C30 32 31 37 32 40Z" fill="#6C63FF" opacity="0.6" />
    </svg>
  )
}
...
function SproutSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Right leaf */}
      <path d="M32 34C40 28 44 22 38 18C32 14 32 26 32 34Z" fill="#6C63FF" opacity="0.7" />
      {/* Top bud */}
...
function SaplingSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Trunk */}
      <path d="M32 54V24" stroke="#6C63FF" strokeWidth="3" strokeLinecap="round" />
      {/* Left branch */}
      <path d="M32 36L22 26" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" />
      {/* Right branch */}
      <path d="M32 30L42 22" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" />
      {/* Leaves cluster - left */}
      ...
      <circle cx="40" cy="16" r="4" fill="#6C63FF" opacity="0.5" />
      {/* Top crown */}
...
function BloomSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Trunk */}
      <path d="M32 54V28" stroke="#6C63FF" strokeWidth="3" strokeLinecap="round" />
      {/* Branches */}
      <path d="M32 40L20 32" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" />
      <path d="M32 36L44 28" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" />
      {/* Crown */}
...
function TreeSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Trunk */}
      <path d="M32 56V32" stroke="#6C63FF" strokeWidth="4" strokeLinecap="round" />
      {/* Full crown */}
      <ellipse cx="32" cy="22" rx="18" ry="16" fill="url(#tree-crown)" opacity="0.7" />
      <ellipse cx="26" cy="18" rx="10" ry="10" fill="#4ECDC4" opacity="0.5" />
      <ellipse cx="38" cy="16" rx="10" ry="10" fill="#6C63FF" opacity="0.3" />
      {/* Fruit/flowers */}
...
function OakSvg({ size }: { size: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} fill="none">
      ...
      {/* Trunk */}
      <path d="M32 56V30" stroke="#6C63FF" strokeWidth="5" strokeLinecap="round" />
      <path d="M30 42L18 34" stroke="#6C63FF" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M34 38L46 30" stroke="#6C63FF" strokeWidth="2.5" strokeLinecap="round" />
      {/* Majestic crown */}
      <ellipse cx="32" cy="20" rx="22" ry="18" fill="url(#oak-crown)" opacity="0.6" />
      <ellipse cx="22" cy="16" rx="12" ry="12" fill="#4ECDC4" opacity="0.4" />
      <ellipse cx="42" cy="14" rx="12" ry="12" fill="#6C63FF" opacity="0.3" />
