  ...
  return (
    ...
    <div className="min-h-screen px-5 pb-36 pt-10" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      <div className="space-y-4 mt-5">
        ...
        {/* VOLAURA Crystal Balance — shown independently when user has crystals */}
        {auraState && auraState.crystal_balance > 0 && (
          <motion.div
            initial={shouldAnimate ? { opacity: 0, y: 12 } : false}
            animate={shouldAnimate ? { opacity: 1, y: 0 } : false}
          ...
          >
            <div>
              <p className="text-[11px] uppercase tracking-widest mb-0.5" style={{ color: 'var(--color-gold)' }}>
                VOLAURA
              </p>
        ...
        {/* VOLAURA AURA Badge — verified skills (shown only when skills exist) */}
