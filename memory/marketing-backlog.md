...
- [x] **Ротация ОТЛОЖЕНА до news-day-14** (2026-07-19). Причина: живая финишная черта = 14 дней НОВОСТЕЙ; второй формат в CI до этого = расширение скопа до доказательства базы. В окне ожидания строим банк 30 вопросов (факт-чек), чтобы go-live был флипом, не стройкой.
