...
- [ ] **Вердикт по образцу Ladder v4**: принят ли формат для серии? (блокирует банк 30 вопросов + ротацию)
- [ ] **Слот ротации**: Ladder через день с новостями на существующих IG+TikTok — да/нет?
- [ ] **Дубль 07-06 в ленте**: второй пост (IG 6a4b6c46… / TT 6a4b6c51…, ~12:50 Baku) удалить руками или оставить? Дальше дубли блокирует журнал.
