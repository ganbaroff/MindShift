...
|--------|--------|-------------|
| BATCH-2026-04-04-R "feature graphic" | `pending` | Feature graphic 1024×500 (2048×1000 @2×) via Playwright HTML render. Dark theme, ADHD-safe palette, phone mockup. capture-feature-graphic.ts script added. tsc -b ✅ |
